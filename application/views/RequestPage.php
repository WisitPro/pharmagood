    ...
    <div id="container">
        ...
        <div id="orange2">
            ...
            <?php if ($ss_req_status === false) { ?>
                <a href="<?php echo base_url('index.php/RequestController/RequestForm');?>" style="color:white;"><button id="btRq">นัดเวลาปรึกษาเภสัชกร</button></a>
            <?php } else if ($ss_req_status === true) { ?>
                <a href="<?php echo base_url('index.php/RequestController/MyCurrentRQ');?>" style="color:white;"><button id="btRq">ดูการนัดของคุณ</button></a>
            <?php } ?>
