...
<body>
    <div id="backform2">
        ...
        <tr id="tr1">
                    ...
                    <th style="min-width:100px  ;" class="st2" >สถานะ</th>
    ...
    <div class="modal-content">
      ...
      <div id="form2" action="">
                ...
                <i id="x" class="fa-solid fa-circle-xmark fa-2xl" onclick="window.location.href='http://localhost/pharmagood/index.php/RequestController/ListRQ2';"></i>
...
<script>
  ...
  var callBT = document.getElementById("callBT");
  ...
  for (var i = 0; i < rows.length; i++) {
    ...
    callBT.href = "<?php echo base_url('/index.php/RequestController/AdminCall/'); ?>" + request[key]['req_id'];
