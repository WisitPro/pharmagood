  ...
  <div id="myModal" class="modal">
    <div class="modal-content">
      ...
      <a href="<?php echo base_url('/index.php/ProductController/AddtoCart/'); ?>" id="addToCartLink">
        <button id="addToCartButton" name="add_product" style="background-color:#F69A56;color:white;border:transparent;width:200px;height:40px;font-size:20px;float:right;margin-right:60px">เพิ่มไปยังตะกร้า</button></a>
