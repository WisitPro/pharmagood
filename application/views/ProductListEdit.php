    ...
    <div id="form">
        <form action="Product_Update" method="POST">
            ...
            <!-- <?php if ($type = "ยาลดกรด แก้ท้องอืด") { ?>
                ...
                <option>เวชภัณฑ์</option>
                <option>อุปกรณ์อื่นๆ</option>
            <?php } elseif ($type = "ยาบรรเทาอาการท้องเสีย") { ?>
                ...
                <option>เวชภัณฑ์</option>
                <option>อุปกรณ์อื่นๆ</option>";
                <?php } elseif ($type = "ยาระบายแก้ท้องผูก") { ?>
                echo "<option >ยาลดกรด แก้ท้องอืด</option>
                <option >ยาบรรเทาอาการท้องเสีย</option>
                ...
                <option>เวชภัณฑ์</option>
                <option>อุปกรณ์อื่นๆ</option>";
                <?php } elseif ($type = "ยาแก้ปวด ลดไข้") { ?>
                echo "<option >ยาลดกรด แก้ท้องอืด</option>
                <option >ยาบรรเทาอาการท้องเสีย</option>
                <option>ยาระบายแก้ท้องผูก</option>
                ...
                <option>เวชภัณฑ์</option>
                <option>อุปกรณ์อื่นๆ</option>";
                <?php } elseif ($type = "ยาแก้แพ้ คัน ผื่น") { ?>
                echo "<option >ยาลดกรด แก้ท้องอืด</option>
                <option >ยาบรรเทาอาการท้องเสีย</option>
                <option>ยาระบายแก้ท้องผูก</option>
                <option>ยาแก้ปวด ลดไข้</option>
                ...
                <option>เวชภัณฑ์</option>
                <option>อุปกรณ์อื่นๆ</option>";
                <?php } elseif ($type = "ยาแก้ไอ ขับเสมหะ") { ?>
                echo "<option >ยาลดกรด แก้ท้องอืด</option>
                <option >ยาบรรเทาอาการท้องเสีย</option>
                <option>ยาระบายแก้ท้องผูก</option>
                <option>ยาแก้ปวด ลดไข้</option>
            ...
            <br><br>
            <p id="img">ลิ้งค์รูปภาพ: <input type="text" class=" pro_img" name="pro_img" value="<?php echo $row->pro_img ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
