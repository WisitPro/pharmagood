        ...
        <form>
            ...
            <form id="form2" action="">
                ...
                <p>ชื่อ-นามสกุล<span>*</span><br>
                    <input type="text" value="<?php echo $name ?>" disabled></input>
                </p>
                <p>เบอร์โทร<span>*</span><br>
                    <input type="text" value="<?php echo $phone ?>" disabled></input>
                </p>
                ...
                <p>วันและเวลาที่ต้องการปรึกษา<span>*(โปรดระบุเวลามากกว่า 30 นาทีขึ้นไป)</span><br>
                    <input disabled type="text" name="req_time" value="<?php echo date_format($req_time,"d/m/Y H:i:s"); ?> " ></input>
                </p>
