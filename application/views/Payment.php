...
<body onload="disBt()" onload="initMap()">
    ...
    <div id="p3">
        ...
        <form onsubmit="return confirm('ยืนยันการแจ้งชำระเงิน');" action="<?php echo base_url('/index.php/OrderController/Checkout'); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
            <div id="paymentinput">
                <p id="a2">ธนาคารร้าน :</p>
                <span id="bank">
                ...
                <p><span style="color:red">* </span>ธนาคารที่ชำระเงิน :</p>
                <select name="pay_bank" id="" style="margin-left: 535px;font-size: 18px;border-radius: 15px;height:36px;text-indent: 8px;width: 240px;" required>
