...
class m_bill extends CI_Model
{
    ...
    public function import($data)
    {
         ...
         $sql = "insert into tbl_bills values('$order_id','','$bill_date')";
    ...
    public function OrderDetail($order_id)
    {
        ...
        where pp.order_id = '$order_id'and pp.order_id=o.order_id and o.order_id = ol.order_id and o.cus_id = c.cus_id and ol.pro_id = p.pro_id and b.order_id = pp.order_id; ";
